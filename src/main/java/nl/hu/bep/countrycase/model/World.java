...
public class World {
	public static List<Country> allCountries = new ArrayList<Country>();
	...
	public World() {
		...
		allCountries.add(new Country("KZ", "KAZ", "Kazachstan", "Astana", "Asia", "Southern and Central Asia", 2724900.00, 16223000, "Republic", 51.10, 71.26));
	}
	...
	public Country getCountryByCode(String code) {
		...
		try{
			int index = allCountries.indexOf(code);
